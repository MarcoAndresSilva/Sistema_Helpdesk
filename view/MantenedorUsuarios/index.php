	...
	<div class="page-content">
		<div class="container-fluid">
			...
			<div class="box-typical box-typical-padding">
				<button type="button" id="btnNuevoRegistro" class="btn btn-inline btn-primary-outline data-bs-toggle="modal" data-bs-target="#.bd-example-modal-lg">Nuevo Registro +</button>
